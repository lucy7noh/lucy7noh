...
- **MBTI × 전공 테스트**  
  MBTI 성향과 전공을 결합한 참여형 테스트 웹 서비스  
  사용자 인터랙션 중심의 UI 설계 및 웹 구현
- **마법의 솜라고동**  
  질문을 입력하면 랜덤한 답변을 제공하는 재미형 웹 서비스  
  SNS 공유를 통한 자연스러운 확산 구조 설계  


### 🏅 고려은단 마케팅 공모전 (우수상)
- **건강기능식품 시장 분석 프로젝트**
  - 헬스 디깅(Health Digging) 트렌드 분석
  - 개인 맞춤형 건강기능식품 수요 증가 확인
  - 네이버 쇼핑 리뷰 크롤링 및 전처리 (텍스트 정제, 불용어 제거)
  - 키워드·감정 분석을 통한 소비자 반응 시각화  
